namespace компьютерный_практикум
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write("Введите балл, полученный учеником: ");
            //double mark = double.Parse(Console.ReadLine());
            //if (mark>0 && mark <=60)
            //{
            //    Console.WriteLine($"{mark} оценка неудовлетворительно");
            //}
            //if (mark >60 && mark <= 74)
            //{
            //    Console.WriteLine($"{mark} оценка удавлетворительно");
            //}
            //if (mark >75 && mark <= 89)
            //{
            ...
            //5.Задача 5. Проверка знака случайного числа и его чётности.
            ...
            //Задача 8. Задача 8. Простейший калькулятор на 4 действия.
            //string op;
            ...
            //Задача 9. Задача 9. Вводится возраст человека и в консольное окно выводится возрастная группа, к которой относится человек.
